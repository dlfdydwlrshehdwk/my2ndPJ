<template>
  <main>
        <div class="wrap" style="height:100vh; background-color: ;">
            <div class="bg">
                <ul class="projectul">
            ...
            <div class="pr">
                <ol class="prleft">
                    <li>
                        ...
                        <div>
                            <a href="">
                                <img src="../assets/img/buckhurst_start.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                        ...
                        <div>
                            <a href="">
                                <img src="../assets/img/buckhurst_half.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                    ...
                    <li>
                        <div>
                            <a href="">
                                <img src="../assets/img/manorroad_start.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/manorroad_big.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/manorroad_half.gif" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/manorroad_last.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/manorroad_next.jpg" alt="">
                            </a>
                        </div>
                    </li>
                    <li>
                        <div>
                            <a href="">
                                <img src="../assets/img/dental_small.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/dental_big.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/dental_half.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/dental_half2.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/dental_last.jpg" alt="">
                            </a>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div>
                            <a href="">
                                <img src="../assets/img/nightingale_big.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/nightingale_half.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/nightingale_last.jpg" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/nightingale_next.png" alt="">
                            </a>
                        </div>
                        <div>
                            <a href="">
                                <img src="../assets/img/nightingale_start.jpg" alt="">
                            </a>
                        </div>
                    </li>
